...
public class SavingsAccount extends Account {
  ...
  public static final double HIGH_RATE = 0.002;

  //The balance at which the applied interest rate increases from LOW_RATE to HIGH_RATE
  public static final double LOW_HIGH_BOUNDARY = 1000.0;

  //The total LOW_RATE interest accrued on an balance equal to LOW_HIGH_BOUNDARY
  public static final double TOTAL_LOW_INTEREST = LOW_HIGH_BOUNDARY * LOW_RATE;
