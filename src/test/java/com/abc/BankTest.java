...
public class BankTest {
    ...
    public void testProduceCustomerSummary() {
        ...
        assertEquals("Customer Summary\n - John (1 account)", SimpleReport.bankCustomerSummary(bank));
    }
    ...
    public void testCheckingAccount() {
		...
		Date transactionDate = DateUtil.addDays(new Date(), -1);
    ...
    public void testSavingsAccount() {
        Bank bank = new Bank();
        Account checkingAccount = AccountFactory.createAccount(AccountType.SAVINGS);
    ...
    public void testMaxiSavingsAccount() {
        Bank bank = new Bank();
        Account checkingAccount = AccountFactory.createAccount(AccountType.MAXI_SAVINGS);
        bank.addCustomer(new Customer("Bill").openAccount(checkingAccount));
